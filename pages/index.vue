...
const { data: count } = await useFetch('https://fakestoreapi.com/products')
  ...
  <div>
              ...
              <div class="pt-6" id="filter-section-mobile-1">
                <div class="space-y-6">
                  <div class="flex items-center">
                    ...
                    <label for="filter-mobile-category-0" class="ml-3 min-w-0 flex-1 text-gray-500">Tapp Shop</label>
                  </div>
                  <div class="flex items-center">
    ...
    <main class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div class="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-24">
        <h1 class="text-4xl font-bold tracking-tight text-gray-900">Tapp shop</h1>
        ...
        <div class="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
              ...
              <div class="pt-6" id="filter-section-1">
                <div class="space-y-4">
                  <div class="flex items-center">
                    ...
                    <label for="filter-category-0" class="ml-3 text-sm text-gray-600">Tapp shop</label>
                  </div>
                  <div class="flex items-center">
          ...
          <div class="lg:col-span-3">
            <div class="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
                    <!-- <div v-for="product in count" :key="product.id">
                    ...
                    <div v-for="product in count" :key="product.id" class="group relative">
                        <NuxtLink :to="`/product/${product.id}`">
