          ...
          <form class="hidden lg:block">
            ...
            <div class="border-b border-gray-200 py-6">
              ...
              <div class="pt-6" id="filter-section-1">
                <div class="space-y-4">
                  <!-- Gebruik v-for om elke categorie te mappen naar een checkbox -->
                  <div class="flex items-center" v-for="(category, index) in categories" :key="index">
                    <input :id="`filter-category-${index}`" :name="`category[]`" :value="category" @change="handleCategoryChange($event, category)" type="checkbox" class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
